...
const I18N = {
  ca: {
    ...
    "hero.pillars": "Arrels · Foc · Pirineu",
  ...
  es: {
    ...
    "hero.pillars": "Raíces · Fuego · Pirineo",
  ...
  fr: {
    ...
    "hero.pillars": "Racines · Feu · Pyrénées",
  ...
  en: {
    ...
    "hero.pillars": "Roots · Fire · Pyrenees",
    ...
    "exp.lede": "Signature Argentine cooking, in the heart of the Pyrenees. A cuisine that draws on our roots, combines selected Argentine produce with local ingredients, and finds in fire its way of expressing itself.",
