...
const I18N = {
  ca: {
    ...
    "cuina.p2": "Aquí cuinem des de zero. Empanades, salses, guarnicions, postres i cada elaboració que arriba a la taula neix a la nostra pròpia cuina, tenint cura del producte, de cada procés i deixant sempre un lloc protagonista al foc.",
    ...
    "exp.eyebrow": "Les nostres arrels", "exp.title": "Cuina argentina d'autor, al cor del Pirineu.",
    "exp.lede": "Una cuina que neix de les nostres arrels, combina producte argentí seleccionat amb producte de proximitat i troba en el foc la seva manera d'expressar-se.",
  ...
  es: {
    ...
    "exp.eyebrow": "Nuestras raíces", "exp.title": "Cocina argentina de autor, en el corazón del Pirineo.",
    "exp.lede": "Una cocina que parte de nuestras raíces, combina producto argentino seleccionado con producto de proximidad y encuentra en el fuego su forma de expresarse.",
  ...
  fr: {
    ...
    "carta.lede": "Un menu né de nos racines argentines, porté à notre façon. Produit argentin sélectionné, produit de proximité, élaborations maison et le feu en protagoniste.",
    "carta.note": "* Menu indicatif, selon le marché et la saison. Prix TVA incluse.",
    "carta.veureTot": "Voir la carte complète",
    "exp.eyebrow": "Nos racines", "exp.title": "Cuisine argentine d'auteur, au cœur des Pyrénées.",
    "exp.lede": "Une cuisine qui puise dans nos racines, associe un produit argentin sélectionné à un produit de proximité, et trouve dans le feu sa façon de s'exprimer.",
  ...
  en: {
    ...
    "cuina.p2": "Here, we cook from scratch. Empanadas, sauces, sides, desserts and every preparation that reaches the table is born in our own kitchen, taking care of the produce, of every process, and always giving fire the leading role.",
    ...
    "exp.eyebrow": "Our roots", "exp.title": "Signature Argentine cooking, in the heart of the Pyrenees.",
    "exp.lede": "A cuisine that draws on our roots, combines selected Argentine produce with local ingredients, and finds in fire its way of expressing itself.",
